...
public final class EventReplanGameTests implements FabricGameTest {
    @GameTest(batch = "event_replan", template = FabricGameTest.EMPTY_STRUCTURE, timeoutTicks = 1200000)
    public void collectReplanAndDeliverOriginalGoal(GameTestHelper helper) { new Fixture(helper).start(); }
    ...
    private static final class Fixture {
        ...
        Fixture(GameTestHelper helper) {
            ...
            owner = new ServerPlayer(level.getServer(), level, new GameProfile(UUID.randomUUID(), "ReplanOwner"), ClientInformation.createDefault());
