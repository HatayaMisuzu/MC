...
public final class FinalProductGameTests implements FabricGameTest {
    @GameTest(template = FabricGameTest.EMPTY_STRUCTURE, timeoutTicks = 4500, batch = "final_product")
    public void nonOwnerFollowCrossesTerrainReacquiresIdentityAndSurvivesThreat(GameTestHelper helper) {
        var f = new CombatGameTests.Fixture(helper, 3072);
    ...
    private static void observeTerrain(CombatGameTests.Fixture f, boolean[] observed) {
    ...
    private static void followWaypoints(CombatGameTests.Fixture f, ServerPlayer target, int[] waypoints, int index, Runnable done) {
