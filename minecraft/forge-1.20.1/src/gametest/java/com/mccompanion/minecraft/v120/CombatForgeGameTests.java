...
public final class CombatForgeGameTests {
    @GameTest(batch = "combat_core", templateNamespace = "minecraft", template = "bastion/mobs/empty", timeoutTicks = 600)
    public static void meleeChasesMovingZombieAndVerifiesDeath(GameTestHelper helper) {
    ...
    @GameTest(batch = "combat_core", templateNamespace = "minecraft", template = "bastion/mobs/empty", timeoutTicks = 500)
    public static void shieldBlocksLowersAttacksAndCancels(GameTestHelper helper) {
    ...
    @GameTest(batch = "combat_core", templateNamespace = "minecraft", template = "bastion/mobs/empty", timeoutTicks = 700)
    public static void bowTracksMovingTargetAndPauseDoesNotFire(GameTestHelper helper) {
    ...
    @GameTest(batch = "combat_core", templateNamespace = "minecraft", template = "bastion/mobs/empty", timeoutTicks = 400)
    public static void combatMissingAmmoLostIdentityAndBlockedPathFailHonestly(GameTestHelper helper) {
    ...
    static final class Fixture {
        ...
        Fixture(GameTestHelper helper, int coordinate) {
            ...
            registry = MinecraftAiCompanionForge.integrationRegistryFor(helper.getLevel().getServer());
