...
public final class WorldModelForgeGameTests  {
    @GameTest(batch = "world_model", templateNamespace = "minecraft", template = "bastion/mobs/empty", timeoutTicks = 1200000)
    public static void realWorldFeedsBoundedModel(GameTestHelper helper) {
    ...
    private static final class Fixture {
        ...
        Fixture(GameTestHelper helper) {
            ...
            owner = new ServerPlayer(level.getServer(), level, new GameProfile(UUID.randomUUID(), "WorldModelOwner"));
