...
public final class FakeConnection extends Connection {
    ...
    public FakeConnection() {
        ...
        // Installing this Connection as the embedded handler drives vanilla channelActive(...),
        // which initializes the private channel field used by NeoForge's channel() extension.
