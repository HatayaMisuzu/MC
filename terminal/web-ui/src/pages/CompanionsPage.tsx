...
export function CompanionsPage() {
  ...
  return (
    <div className="page">
      ...
      {selected.mode === 'LOCAL_ONLY' ? <EmptyState title="LOCAL_ONLY"><StatusBadge value="LOCAL_ONLY" /> 当前 Loader 没有 Runtime Bridge，页面不会伪造 Companion 在线状态。</EmptyState> : !companions.length ? <EmptyState title="尚未发现在线 Companion">启动并进入受支持的 Minecraft 世界后，在游戏中创建 Companion；认证握手完成后会自动出现在这里。</EmptyState> : <>
